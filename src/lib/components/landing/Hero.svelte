<script lang="ts">
  ...
  // Skeleton note cards — no fake data, just structure
  const skeletonNotes = [
...
<section class="min-h-screen bg-zinc-900 px-6 relative overflow-hidden flex flex-col items-center justify-center pt-28 pb-16">
  ...
  <div class="w-full max-w-3xl flex flex-col items-center text-center transition-all duration-1000
    ...
    <!-- Brief description — centred, not too wide -->
    ...
    <!-- Note preview grid — square cards like picture frames -->
    <div class="w-full">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {#each skeletonNotes as note}
          <Card.Root class="bg-zinc-800/50 border-zinc-700/60 rounded-xl overflow-hidden
            ...
            <!-- Picture frame top — square aspect ratio -->
            <div class="aspect-square bg-zinc-800 border-b border-zinc-700/60 flex items-center justify-center relative">
              <!-- Decorative lines mimicking a note page -->
