...
<section id="features" class="bg-zinc-900 py-24 px-6 border-t border-zinc-800/60 relative overflow-hidden">

  <SectionBg position="right" opacity={0.12} />
  ...
  <div class="max-w-5xl mx-auto relative z-10">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 items-start">
      ...
      <!-- LEFT: thumbnail — hover triggers feature reveal -->
      <Card.Root
      ...
      >
        <div class="aspect-square bg-zinc-800 relative overflow-hidden">
          <img src="$lib/assets/webp/thumbnail.webp" alt="Platform preview"
        ...
        <Card.Content class="p-4">
          ...
          <p class="text-zinc-500 text-xs leading-relaxed">
            A complete study and social platform — notes, groups, chat and rewards in one place.
          </p>
        </Card.Content>
      </Card.Root>

      <!-- RIGHT: feature list revealed on hover -->
          ...
          {#each features as feature, i}
            ...
            >
              <Card.Content class="p-3 flex items-center gap-3">
                <div class="w-8 h-8 rounded-lg bg-zinc-700/50 border border-zinc-700
